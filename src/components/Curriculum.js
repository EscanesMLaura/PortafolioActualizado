...
export const Curriculum = () => {
  return (
    <div className="pagina">
      ...
      <ul>
        <li><b>Desarrolladora FrontEnd React Trainee - Pasante PIL </b>
          <br />
          &nbsp;<em>jun. 2023 - Actualidad</em>
        </li>
      </ul>
      <br />
      <br />
      ...
      <ul>
        <li><b>Asistente de Gerencia</b>
          <br />
          &nbsp;<em>sept. 2017 - may. 2023 · 5 años 9 meses</em>
          <ul>
            <br />
            <li>Encargada en mi turno del local comercial y su administración</li>
            <li>Equipo a cargo</li>
            <li>Cierre de caja del personal y manejo de caja fuerte</li>
            <li>Coordinación de horarios del personal</li>
            <li>Distribución de tareas diarias</li>
            <li>Trato con los proveedores</li>
            <br />
          </ul>
        </li>
        <li><b>Auxiliar de caja</b>
          <br />
          &nbsp;<em>jul. 2016 - ago. 2017 · 1 año 2 meses</em>
          <ul>
            <br />
            <li>Cierre de caja del personal y manejo de caja fuerte</li>
            <li>Distribución de tareas diarias</li>
        ...
        <li><b>Cajero / Repositor</b>
          <br />
          &nbsp;<em>ene. 2012 - jun. 2016 · 4 años 6 meses</em>
          <ul>
            <br />
      ...
      <ul>
        <li><b>Oficial técnico</b>
          <br />
          &nbsp;<em>ago. 2007 - ene. 2012 · 4 años 6 meses</em>
          <ul>
            <br />
            <li>Encargada de tareas de proyección de películas</li>
            <li>Armado y desarmado de películas</li>
            <li>Mantenimiento de los proyectores</li>
            <li>Participación en tareas de mantenimiento del local</li>
            <br />
          </ul>
        </li>
        <li><b>Personal de ventas</b>
          <br />
          &nbsp;<em>may. 2007 - jul. 2007 · 3 meses</em>
          <ul>
            <br />
            <li>Atención al cliente</li>
            <li>Manejo de caja</li>
